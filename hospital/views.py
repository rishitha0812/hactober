...
from Dr_Consultancy.settings import EMAIL_HOST_USER
        ...
        try:
            ...
            if(user_authenticate != None):
                ...
                try:
                    ...
                    print(data)
                    messages.success(request, "Patient has been Logged in." )
                    ...
                    try:
                        ...
                        auth.login(request,user_authenticate)               
                        messages.success(request, "Docter has been Logged in." )
                ...
                messages.error(request, "incorrect credentials... register before logging in" )
